...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/orginfo/list.js"></script> 
...
<div class="m-b-md">
	<form class="form-inline" role="form" id="searchForm" name="searchForm">
		...
		<a href="javascript:void(0)" class="btn btn-default" id="才">查询</a>
	...
	<div>
		<form action="" class="form-horizontal">
			<table class="pp-list table table-striped table-bordered"
				...
				<tbody id="shippinginfos">
					<c:forEach items="${shippinginfos}" var="key">
						<tr>
							<td style="text-align: center"><input type="checkbox" name="shippinginfos" value="${key.id}@_@${key.orgname}" /> </td>
