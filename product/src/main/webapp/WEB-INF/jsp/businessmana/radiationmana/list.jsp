...
<body>
	<div class="m-b-md">
		...
		<tr>
		<td>货物名称</td> <td><input id="divcargoname" name="divcargoname" type="text" disabled="disabled" /> <input type="hidden" id="receiveorgid" name="receiveorgid" /> </td>
		</tr>
		<tr>
		<td>辐照数量</td>
		 <td> 
		...
		<tr>
		<td>辐照方式</td> <td><crazy:dictselect id="irradtypes" name="irradtypes" collection="${irradtypes}"  ></crazy:dictselect></td>
		</tr>
		<tr>
		<td>辐照时间</td><td> <input type="text" id="irradtime" name="irradtime" /> <crazy:dictselect id="timeorgs" name="timeorgs" collection="${timeorgs}"  ></crazy:dictselect> </td>
		</tr>
		<tr>
		<td>放置位置</td> <td> <input type="text" id="position" name="position" /> </td>
		</tr>
		</table>
