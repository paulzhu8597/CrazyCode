...
import com.product.entity.LogFormMap;
import com.product.entity.User;
import com.product.mapper.LogMapper;
...
public  class LogAopAction {
    //本地异常日志记录对象
     ...
     //Controller层切点
    @Pointcut("@annotation(com.product.annotation.SystemLog)")
    ...
    public  void doAfterThrowing(JoinPoint point, Throwable e) {  
		...
		try {
			...
			// 登录名
			user = ((User)session.getAttribute("user")).getUserId();
