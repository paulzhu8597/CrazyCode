...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="header">
            ...
            <a href="../login/toLogin.action">[退出]</a>   
        ...
        <div id="main">            
            ...
            <form action="addRole.action" method="post" class="main_form" id="roleform">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                    <%--<input type="text" class="width200" name="role.name" />
                    --%>
                    <s:textfield cssClass="width200" name="role.name" onblur="checkrolename();"></s:textfield>
