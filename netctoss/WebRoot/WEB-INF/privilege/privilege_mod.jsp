        ...
        <div id="report_main">
            ...
            <div class="report_box">
                ...
                <div id="report_data" align="left" >
                    <form id="privilegeform" name="privilegeform" action="privilege/modPrivilege.action" method="post">
					<input type="button" value="增加一条" id="addbtn" class="btn_add" /><br>
					模块名称：
					<s:textfield name="privilege.name"  type="text" />
					<br> 
					模块ID：&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield name="privilege.id"  onblur="checkIdExist(this.value);" /><span id="idnotifyinfo"></span><br>
					允许Url：
					<div id="div1" style="background-color: silver">
						<s:iterator value="privilege.urls" >
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="privilege.strurls" type="text" value="<s:property/>" /><br>	
						</s:iterator>
					</div>
