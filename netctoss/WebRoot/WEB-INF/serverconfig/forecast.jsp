...
<%-- <%@include file="../../common/common-css.jsp"%> --%>
   <link href="${pageContext.servletContext.contextPath }/styles/showLoading.css" rel="stylesheet" media="screen" /> 
...
$(function(){
	$(".loading").showLoading(); 
	var url = "${pageContext.request.contextPath}/serverconfig/towarninfo.action";
	$.ajax({
		type : 'POST',
		url : url,
		dataType : 'json',
...
function modifySer(key){
	$.ajax({
        async: false,
        url: "${pageContext.request.contextPath}/serverconfig/towmodifyser.action?a=1",
